...
<?php } ?>
	...
	<link rel="stylesheet" href="//pokemonshowdown.com/theme/panels.css?0.29403140565240227" />
	<link rel="stylesheet" href="//pokemonshowdown.com/theme/main.css?0.14690892765614194" />
	...
	<div class="pfx-topbar">
		<div class="header">
			<ul class="nav">
				<li><a class="button nav-first<?php if ($panels->tab === 'home') echo ' cur'; ?>" href="//pokemonshowdown.com/?0.18925171633524007"><img src="//pokemonshowdown.com/images/pokemonshowdownbeta.png?0.5436204927380834" alt="Pok&eacute;mon Showdown! (beta)" /> Home</a></li>
				<li><a class="button<?php if ($panels->tab === 'pokedex') echo ' cur'; ?>" href="//dex.pokemonshowdown.com/?0.24313813699411924">Pok&eacute;dex</a></li>
				<li><a class="button<?php if ($panels->tab === 'replay') echo ' cur'; ?>" href="/?0.09506329021440307">Replays</a></li>
				<li><a class="button<?php if ($panels->tab === 'ladder') echo ' cur'; ?>" href="//pokemonshowdown.com/ladder/?0.5757417329796228">Ladder</a></li>
				<li><a class="button nav-last" href="//pokemonshowdown.com/forums/?0.195796099102459">Forum</a></li>
			</ul>
...
?>
	...
	<script src="//dex.pokemonshowdown.com/js/panels.js?0.13278314934856472"></script>
<?php
}
...
<?php $panels->scripts(); ?>
	...
	<script src="//play.pokemonshowdown.com/config/config.js?ef2bc62a"></script>
	...
	<script src="//play.pokemonshowdown.com/data/pokedex.js?babf4acd"></script>
	<script src="//play.pokemonshowdown.com/data/items.js?752e505e"></script>
	<script src="//play.pokemonshowdown.com/data/moves.js?c457f732"></script>
	<script src="//play.pokemonshowdown.com/data/abilities.js?2728fc82"></script>
	<script src="//play.pokemonshowdown.com/data/teambuilder-tables.js?ddfddddc"></script>
