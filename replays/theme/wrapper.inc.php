...
<?php } ?>
	...
	<link rel="stylesheet" href="//pokemonshowdown.com/theme/panels.css?0.029924289572986984" />
	<link rel="stylesheet" href="//pokemonshowdown.com/theme/main.css?0.1777482051074144" />
	...
	<div class="pfx-topbar">
		<div class="header">
			<ul class="nav">
				<li><a class="button nav-first<?php if ($panels->tab === 'home') echo ' cur'; ?>" href="//pokemonshowdown.com/?0.9964825997603499"><img src="//pokemonshowdown.com/images/pokemonshowdownbeta.png?0.5198102976014252" alt="Pok&eacute;mon Showdown! (beta)" /> Home</a></li>
				<li><a class="button<?php if ($panels->tab === 'pokedex') echo ' cur'; ?>" href="//dex.pokemonshowdown.com/?0.9397557427161747">Pok&eacute;dex</a></li>
				<li><a class="button<?php if ($panels->tab === 'replay') echo ' cur'; ?>" href="/?0.5256105601143848">Replays</a></li>
				<li><a class="button<?php if ($panels->tab === 'ladder') echo ' cur'; ?>" href="//pokemonshowdown.com/ladder/?0.46883249939298643">Ladder</a></li>
				<li><a class="button nav-last" href="//pokemonshowdown.com/forums/?0.1580064105662944">Forum</a></li>
			</ul>
...
?>
	...
	<script src="//dex.pokemonshowdown.com/js/panels.js?0.2705093104765559"></script>
<?php
}
...
<?php $panels->scripts(); ?>
	...
	<script src="//play.pokemonshowdown.com/config/config.js?a916bb8d"></script>
	...
	<script src="//play.pokemonshowdown.com/data/pokedex.js?3e61c953"></script>
