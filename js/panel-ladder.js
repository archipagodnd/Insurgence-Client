...
requestLadderData=function(searchValue){var _PS=
PS,teams=_PS.teams;
...
function LadderFormat(props){var
room=props.room;var
...
componentDidMount=function componentDidMount(){var _this2=this;var
...
if(response){var
format=response[0],ladderData=response[1];
