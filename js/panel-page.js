...
_this=_PSRoom.call(this,options)||this;_this.classType='html';_this.page=_this.id.split("-")[1];_this.canConnect=true;_this.loading=true;_this.setHTMLData=function(htmlData){_this.loading=false;_this.htmlData=htmlData;_this.update(null);};
...
function PageLadderHelp(props){var
room=props.room;
...
receiveLine=function receiveLine(args){var
...
return true;
case'tempnotify':{var
id=args[1],title=args[2],body=args[3];
